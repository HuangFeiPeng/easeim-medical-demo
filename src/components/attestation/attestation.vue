<template>
  <div class="attestation main_content">
    <div class="attestation_box">
      <div class="attestation_box_header">
        <span class="img"></span>
        <p class="text">医师认证成功</p>
      </div>
      <div class="attestation_box_profile">
        <p class="text">医生头像</p>
        <img src="../../assets/imgs/占位01.jpeg" alt="" />
      </div>
      <div class="attestation_box_ID">
        <p class="text">身份证件(正反面需均需上传)</p>
        <div class="img_box">
          <img src="../../assets/imgs/占位02.jpeg" alt="" />
          <img src="../../assets/imgs/占位03.jpeg" alt="" />
        </div>
      </div>
...
export default {
  ...
  methods: {
    changeBtn() {
      this.$Toast.fail('暂不支持修改认证！')
    },
  },
}
</script>
<style lang="scss" scoped>
// @import url('./attestation.scss');
.nav_bar {
  background: #f7f8fa;
  .text {
    color: #535568;
